...
const SparkDetailView: React.FC = () => {
    ...
    return (
        <Page className={styles.root}>
            ...
            <p className={styles.description}>
                Description: Biden considers deporting Elon because it is reported by the WSJ that he worked on his
                startup during his graduate studies at Stanford in 1995 - which is illegal. Elon is accused of having
                lied to the immigration office.
            </p>
            ...
            <div className={styles.commentsSection}>
                <div className={styles.commentsTopBar}>
                    ...
                    <div className={styles.commentsTopBarRight}>
                        <ToggleSwitch options={['Popular', 'Recent']} onToggle={(o) => console.log(o)} />
                    </div>
                </div>
                <Comment />
                <Comment />
...
export default SparkDetailView;
